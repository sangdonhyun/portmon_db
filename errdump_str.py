...
class err_dump():
    def __init__(self,serial,dumpstr):
        self.serial=serial
...
2020/02/14-05:14:22, [SEC-1193], 122406, FID 128, INFO, Fsw_01, Security violation: Login failure attempt via TELNET/SSH/RSH. IP Addr: 195.211.213.36
    """    
    def line_set(self):
        return self.dumpstr.splitlines()
...
#         print os.path.isfile(cfgFile)
    ...
    def get_config_name(self):
        ...
        timeconfig=os.path.join('config','{}.conf'.format(self.serial))
        return timeconfig
